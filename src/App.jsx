...
function TermsPage() {
  return (
    <div className="page-shell container legal-page">
      ...
      <p>Participants are encouraged to understand the program details, review their personal goals, and make decisions that align with their individual circumstances.Market prices may fluctuate, liquidity may be limited, regulatory environments may change, and external economic conditions may affect the value of assets or participation outcomes. These factors can affect profit, return of capital, preservation of value.</p>
